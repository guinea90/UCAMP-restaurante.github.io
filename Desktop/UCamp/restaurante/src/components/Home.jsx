            ...
            <div className="catalogo">
                ...
                <div class="container-catalogo">
                    <div class="item div-catalogo">
                        ...
                        <div><p className="p-catalogo3"><a className="nombre" href="#">Ver más</a></p></div></section>
                    </div>
                    <div class="item div-catalogo">
